...
class ConfirmForgotPinPage extends StatefulWidget {
  final ForgotPinExtra extra;
  const ConfirmForgotPinPage({super.key, required this.extra});

  @override
  State<ConfirmForgotPinPage> createState() => _ConfirmForgotPinPageState();
}

class _ConfirmForgotPinPageState extends State<ConfirmForgotPinPage> {
  String _pin = '';
